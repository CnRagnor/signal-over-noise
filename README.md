...
| [OSSInsight](https://ossinsight.io) | Advanced data analysis platform for GitHub — deep visualization of repo stars and bot/fake star detection |
| [Gitleaks](https://github.com/gitleaks/gitleaks) | The 2026 industry standard for scanning commit history to find leaked API keys, secrets, and credentials |
...
## 🗺️ Investigation Workflow — Quick Reference — Quick Reference
...
| **Repo Secrets** | `Org Name` → `TruffleHog` → `GitLeak` → `h8mail` | Finds exposed credentials before attackers do. |
